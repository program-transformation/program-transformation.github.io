...
-   **TWiki Webs**
    ...
    -   [CC[^?^](http://www.program-transformation.org/edit/CC/WebHome?topicparent=TWiki.FileAttachment)]{.twikiNewLink
...
-   [Edit
    Page](http://www.program-transformation.org/edit/TWiki/FileAttachment?t=1536825814)
-   [Rename
    Page](http://www.program-transformation.org/rename/TWiki/FileAttachment)
-   [Attach
    File](http://www.program-transformation.org/attach/TWiki/FileAttachment)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/TWiki/FileAttachment?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/TWiki/FileAttachment?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    13](http://www.program-transformation.org/view/TWiki/FileAttachment?rev=1.13)
    [(diff 12)](http://www.program-transformation.org/rdiff/TWiki/FileAttachment?rev1=1.13&rev2=1.12)
-   [Rev
    12](http://www.program-transformation.org/view/TWiki/FileAttachment?rev=1.12)
    [(diff 11)](http://www.program-transformation.org/rdiff/TWiki/FileAttachment?rev1=1.12&rev2=1.11)
-   [Rev
    11](http://www.program-transformation.org/view/TWiki/FileAttachment?rev=1.11)
    [(diff 10)](http://www.program-transformation.org/rdiff/TWiki/FileAttachment?rev1=1.11&rev2=1.10)
-   [Total
    History](http://www.program-transformation.org/rdiff/TWiki/FileAttachment)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/TWiki/FileAttachment?template=oopsmore&param1=1.13&param2=1.13)
:::
:::
...
::: {.twikiToc}
-   [File Attachments](FileAttachment#File_Attachments)
    -   [What Are Attachments Good
        For?](FileAttachment#What_Are_Attachments_Good_For)
        -   [Document Management
            System](FileAttachment#Document_Management_System)
        -   [File Sharing](FileAttachment#File_Sharing)
        -   [Web Authoring](FileAttachment#Web_Authoring)
    -   [Uploading Files](FileAttachment#Uploading_Files)
    -   [Downloading Files](FileAttachment#Downloading_Files)
    -   [Moving Attachment
        Files](FileAttachment#Moving_Attachment_Files)
    -   [Deleting Attachments](FileAttachment#Deleting_Attachments)
    -   [Linking to Attached
        Files](FileAttachment#Linking_to_Attached_Files)
    -   [File Attachment Contents
        Table](FileAttachment#File_Attachment_Contents_Table)
    -   [File Attachment
        Controls](FileAttachment#File_Attachment_Controls)
    -   [Known Issues](FileAttachment#Known_Issues)
:::
...
-   You can use Attachments to store and retrieve documents (in any
    ...
    basis](FileAttachment#AttachmentAccess){.twikiAnchorLink} using web
    and topic-level access control; create a central reference library
    that\'s easy to share with an user group spread around the world.
...
-   Click on the `Attach` link at the bottom of the page. The `Attach`
    ...
    table](FileAttachment#FileAttachmentTable){.twikiAnchorLink}.
...
::: {.twikiAttachments}
  [I](FileAttachment@sortcol=0&table=1&up=0#sorted_table "Sort by this column")   [Attachment](FileAttachment){.twikiLink} [![sort](../pub/TWiki/TablePlugin/diamond.gif)](FileAttachment@sortcol=1&table=1&up=0#sorted_table "Sort by this column")   [Action](FileAttachment@sortcol=2&table=1&up=0#sorted_table "Sort by this column")                                                                                  [Size](FileAttachment@sortcol=3&table=1&up=0#sorted_table "Sort by this column") [Date](FileAttachment@sortcol=4&table=1&up=0#sorted_table "Sort by this column")   [Who](FileAttachment@sortcol=5&table=1&up=0#sorted_table "Sort by this column")   [Comment](FileAttachment@sortcol=6&table=1&up=0#sorted_table "Sort by this column")
  ------------------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------------------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------- ---------------------------------------------------------------------------------- ---------------------------------------------------------------------------------- --------------------------------------------------------------------------------- -------------------------------------------------------------------------------------
  ![](../pub/icn/txt.gif){width="16" height="16"}                                 [Sample.txt](../viewfile/TWiki/FileAttachment@rev=1.1&filename=Sample.txt)                                                                                           [manage](http://www.program-transformation.org/attach/TWiki/FileAttachment?filename=Sample.txt&revInfo=1 "change, update, previous revisions, move, delete...")                                                                                0.1 K 22 Jul 2000 - 19:37                                                                Main.thoeny                                                                       Just a sample
  ![](../pub/icn/bmp.gif){width="16" height="16"}                                 [Smile.gif](../viewfile/TWiki/FileAttachment@rev=&filename=Smile.gif)                                                                                                [manage](http://www.program-transformation.org/attach/TWiki/FileAttachment?filename=Smile.gif&revInfo=1 "change, update, previous revisions, move, delete...")                                                                                 0.1 K 22 Jul 2000 - 19:38                                                                Main.thoeny                                                                       Smiley face
:::

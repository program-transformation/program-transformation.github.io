...
-   **TWiki Webs**
    ...
    -   [CC[^?^](http://www.program-transformation.org/edit/CC/WebHome?topicparent=TWiki.WelcomeGuest)]{.twikiNewLink
...
-   [Edit
    Page](http://www.program-transformation.org/edit/TWiki/WelcomeGuest?t=1536826136)
-   [Rename
    Page](http://www.program-transformation.org/rename/TWiki/WelcomeGuest)
-   [Attach
    File](http://www.program-transformation.org/attach/TWiki/WelcomeGuest)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/TWiki/WelcomeGuest?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/TWiki/WelcomeGuest?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    24](http://www.program-transformation.org/view/TWiki/WelcomeGuest?rev=1.24)
    [(diff 23)](http://www.program-transformation.org/rdiff/TWiki/WelcomeGuest?rev1=1.24&rev2=1.23)
-   [Rev
    23](http://www.program-transformation.org/view/TWiki/WelcomeGuest?rev=1.23)
    [(diff 22)](http://www.program-transformation.org/rdiff/TWiki/WelcomeGuest?rev1=1.23&rev2=1.22)
-   [Rev
    22](http://www.program-transformation.org/view/TWiki/WelcomeGuest?rev=1.22)
    [(diff 21)](http://www.program-transformation.org/rdiff/TWiki/WelcomeGuest?rev1=1.22&rev2=1.21)
-   [Total
    History](http://www.program-transformation.org/rdiff/TWiki/WelcomeGuest)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/TWiki/WelcomeGuest?template=oopsmore&param1=1.24&param2=1.24)
:::
:::
...
::: {.twikiTopic}
Welcome Guest {#welcome-guest .twikiTopicTitle}
=============
...
[]{#Welcome_Main_TWikiGuest}[]{#Welcome_Main_TWikiGuest_} Welcome, [TWikiGuest](../Main/TWikiGuest){.twikiLink}!
----------------------------------------------------------------------------------------------------------------

Welcome to TWiki! This is a [TWikiSite](TWikiSite){.twikiLink}
(pronounced *twee-kee site*), a meeting place to work on common
interests. Anyone can contribute using any web browser. TWiki looks like
a normal Web site\... except that it encourages contribution and
**editing** of pages, questions, answers, comments and updates.

***Mission: \"TWiki is a leading-edge, web-based collaboration platform
targeting the corporate intranet world. TWiki fosters information flow
within an organization; lets distributed teams work together seamlessly
and productively; and eliminates the one-webmaster syndrome of outdated
intranet content.\"***

\"Wiki\" systems are fundamentally editable web pages. It\'s a fun and
useful way of communicating asynchronously over the web for many
existing intranet and public Internet sites. TWiki is simple to learn
and use. It aims to provide a transparent way for you to publish and
exchange your ideas with others over the web.

**How TWiki Works**

1.  **Browse.** This is a site like other sites. Read and follow
    interesting links.
    -   **web:** A [TWikiSite](TWikiSite){.twikiLink} is divided into
        webs, each one represents an area for collaboration. Your site
        has the following webs: [Main](../Main/WebHome){.twikiLink}
        [\|]{.twikiSeparator} [TWiki](WebHome){.twikiLink}
        [\|]{.twikiSeparator} [Sandbox](../Sandbox/WebHome){.twikiLink}
    -   **topic:** Each web is made up of hyperlinked topics
        ([TWikiTopics](TWikiTopics){.twikiLink}) that appear in your
        browser.
    -   **WebChanges:** in each TWiki web to find what\'s new
2.  **Write.** Speak your mind! From your browser you can change or add
    to anything you see in a TWiki topic. Use regular text, HTML or
    [TWikiShorthand](TWikiShorthand){.twikiLink}. To contribute:
    -   **Create An Account.** To be able to edit or write new content,
        you\'ll need to create an account for yourself. It\'s simple,
        and only takes a minute.
        [TWikiRegistration](TWikiRegistration){.twikiLink} This will
        also create your personal home page.
    -   click `Edit` at the bottom of any topic and make your changes
    -   click `[ Preview Changes ]` at the bottom to verify the topic
        (use your brower\'s `Back` button if necessary)
    -   click `[ Save Changes ]`
3.  **Don\'t worry!** It can be scary at first to change \"public\"
    content. Please just try it. *Revision control* keeps all content,
    nothing is lost. For special cases, [access
    control](TWikiAccessControl){.twikiLink} is available yet you may
    find you don\'t need it in most cases. You\'ll soon see how
    successful [WikiCulture](WikiCulture){.twikiLink} works in this kind
    of collaboration environment. This is new. Just try to relax.
4.  **Experiment.** Edit your personal page or visit the
    [Sandbox](../Sandbox/WebHome){.twikiLink} web.
    1.  **Link.** To link to another topic, start by editing an existing
        topic.
        -   To create a link to an existing topic type its
            `JoinCapitalizedWords` name.
            [WikiWords](WikiWord){.twikiLink} (two or more capitalized
            words run together) link automatically.
        -   To create a link to a new topic, enter a newly `UsedPhrase`.
        -   When previewing, the links show and \"[?]{.underline}\"
            (question marks) are used to create topics.
        -   Another way to create a topic is to type its
            [WikiWord](WikiWord){.twikiLink} in the Go box or URL.
    2.  **Topic history.** click `Diffs` at the bottom of a topic
    3.  **Attach files.** click `Attach` to upload and attach any type
        of file.
5.  **Organize.** You can learn to use
    [TWikiForms](TWikiForms){.twikiLink} and
    [FormattedSearch](FormattedSearch){.twikiLink}es to include topic
    information - for example, classify pages by subject, status, or
    date.
6.  **Learn more.** [TWikiTutorial](TWikiTutorial){.twikiLink} is a
    20-minute tour of TWiki essentials.
    [ATasteOfTWiki](ATasteOfTWiki){.twikiLink} is a short introduction
    training course for beginners.
    [WikiReferences](WikiReferences){.twikiLink} links to selected
    articles and books about Wiki technology and online collaboration.

+-----------------------------------+-----------------------------------+
| **Starting Points**               | **TWiki Highlights**              |
|                                   |                                   |
| -   **[TWikiTutorial](TWikiTutori | -   **Web browser** used to       |
| al){.twikiLink}** -               |     create and edit topics        |
|     familiarize yourself with     | -   **Automatic linking** HTML    |
|     TWiki                         |     not required                  |
| -   [ATasteOfTWiki](ATasteOfTWiki | -   **Search** topic names or     |
| ){.twikiLink} -                   |     full-text (regular            |
|     a short introduction training |     expressions available)        |
|     course for beginners          | -   **Revision control** for      |
| -   [TWikiRegistration](TWikiRegi |     changes (who, what, when) for |
| stration){.twikiLink} -           |     topics and attachments        |
|     **Sign up to edit** topics,   | -   **Access control** using      |
|     personal home page            |     users and groups              |
| -   [WebChanges](WebChanges){.twi | -   **Email notification** of     |
| kiLink} -                         |     topic changes                 |
|     in this TWiki web             | -   **File attachments** upload   |
| -   [WebHome](WebHome){.twikiLink |     and download any file to any  |
| } -                               |     topic similar to email        |
|     this web\'s entry point       |     attachments                   |
| -   [TWikiSite](TWikiSite){.twiki | -   **Warnings** for simultaneous |
| Link} -                           |     topic editing                 |
|     what is a TWiki site?         | -   **Plug-in** via TWiki\'s      |
| -   [WikiSyntax](WikiSyntax){.twi |     flexible architecture using   |
| kiLink} -                         |     templates, skins, plug-ins    |
|     simple syntax for edits       |     and add-ons to customize      |
| -   [GoodStyle](GoodStyle){.twiki |     everything                    |
| Link} -                           | -   **Development** active with   |
|     recommendations for edits     |     growing set of features in    |
|                                   |     TWiki releases and plug-ins   |
|                                   | -   **Strong community** for      |
|                                   |     support of users,             |
|                                   |     administrators and developers |
|                                   | -   ***Read more*** about TWiki   |
|                                   |     at <http://TWiki.org/>        |
+-----------------------------------+-----------------------------------+
...
[XT[^?^](http://www.program-transformation.org/edit/Tools/XT?topicparent=TWiki.WelcomeGuest)]{.twikiNewLink
...
[SDF2[^?^](http://www.program-transformation.org/edit/Trash/SDFII?topicparent=TWiki.WelcomeGuest)]{.twikiNewLink
style="background : #FFFFCE;"}
[GrammarBase[^?^](http://www.program-transformation.org/edit/Tools/GrammarBase?topicparent=TWiki.WelcomeGuest)]{.twikiNewLink

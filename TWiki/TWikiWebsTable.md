...
-   **TWiki Webs**
    ...
    -   [CC[^?^](http://www.program-transformation.org/edit/CC/WebHome?topicparent=TWiki.TWikiWebsTable)]{.twikiNewLink
...
-   [Edit
    Page](http://www.program-transformation.org/edit/TWiki/TWikiWebsTable?t=1536827495)
-   [Rename
    Page](http://www.program-transformation.org/rename/TWiki/TWikiWebsTable)
-   [Attach
    File](http://www.program-transformation.org/attach/TWiki/TWikiWebsTable)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/TWiki/TWikiWebsTable?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/TWiki/TWikiWebsTable?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    1](http://www.program-transformation.org/view/TWiki/TWikiWebsTable?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/TWiki/TWikiWebsTable)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/TWiki/TWikiWebsTable?template=oopsmore&param1=1.1&param2=1.1)
:::
:::
...
::: {.twikiTopic}
TWiki Webs Table {#twiki-webs-table .twikiTopicTitle}
================
...
[XT[^?^](http://www.program-transformation.org/edit/Tools/XT?topicparent=TWiki.TWikiWebsTable)]{.twikiNewLink
...
[SDF2[^?^](http://www.program-transformation.org/edit/Trash/SDFII?topicparent=TWiki.TWikiWebsTable)]{.twikiNewLink
style="background : #FFFFCE;"}
[GrammarBase[^?^](http://www.program-transformation.org/edit/Tools/GrammarBase?topicparent=TWiki.TWikiWebsTable)]{.twikiNewLink
...
(included from [SiteMap](SiteMap){.twikiLink}; change
[TWikiWebsTable](TWikiWebsTable){.twikiLink} to include from SiteMap

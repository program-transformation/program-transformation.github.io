...
-   [Edit
    Page](http://www.program-transformation.org/edit/HART14/HistoricalStatistics?t=1536828899)
-   [Rename
    Page](http://www.program-transformation.org/rename/HART14/HistoricalStatistics)
-   [Attach
    File](http://www.program-transformation.org/attach/HART14/HistoricalStatistics)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/HART14/HistoricalStatistics?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/HART14/HistoricalStatistics?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    2](http://www.program-transformation.org/view/HART14/HistoricalStatistics?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/HART14/HistoricalStatistics?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/HART14/HistoricalStatistics?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/HART14/HistoricalStatistics)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/HART14/HistoricalStatistics?template=oopsmore&param1=1.2&param2=1.2)
:::
:::

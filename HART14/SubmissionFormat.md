...
-   [Edit
    Page](http://www.program-transformation.org/edit/HART14/SubmissionFormat?t=1536828906)
-   [Rename
    Page](http://www.program-transformation.org/rename/HART14/SubmissionFormat)
-   [Attach
    File](http://www.program-transformation.org/attach/HART14/SubmissionFormat)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/HART14/SubmissionFormat?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/HART14/SubmissionFormat?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    2](http://www.program-transformation.org/view/HART14/SubmissionFormat?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/HART14/SubmissionFormat?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/HART14/SubmissionFormat?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/HART14/SubmissionFormat)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/HART14/SubmissionFormat?template=oopsmore&param1=1.2&param2=1.2)
:::
:::
...
Back to the
[CallForTutorials[^?^](http://www.program-transformation.org/edit/HART14/CallForTutorials?topicparent=HART14.SubmissionFormat)]{.twikiNewLink

...
-   [Edit
    Page](http://www.program-transformation.org/edit/Spoofax/SiteMap?t=1536826264)
-   [Rename
    Page](http://www.program-transformation.org/rename/Spoofax/SiteMap)
-   [Attach
    File](http://www.program-transformation.org/attach/Spoofax/SiteMap)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/Spoofax/SiteMap?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/Spoofax/SiteMap?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    1](http://www.program-transformation.org/view/Spoofax/SiteMap?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/Spoofax/SiteMap)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/Spoofax/SiteMap?template=oopsmore&param1=1.1&param2=1.1)
:::
:::
...
[XT[^?^](http://www.program-transformation.org/edit/Tools/XT?topicparent=Spoofax.SiteMap)]{.twikiNewLink
...
[SDF2[^?^](http://www.program-transformation.org/edit/Trash/SDFII?topicparent=Spoofax.SiteMap)]{.twikiNewLink
style="background : #FFFFCE;"}
[GrammarBase[^?^](http://www.program-transformation.org/edit/Tools/GrammarBase?topicparent=Spoofax.SiteMap)]{.twikiNewLink

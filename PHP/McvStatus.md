...
-   [Edit
    Page](http://www.program-transformation.org/edit/PHP/McvStatus?t=1536826875)
-   [Rename
    Page](http://www.program-transformation.org/rename/PHP/McvStatus)
-   [Attach
    File](http://www.program-transformation.org/attach/PHP/McvStatus)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/PHP/McvStatus?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/PHP/McvStatus?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    1](http://www.program-transformation.org/view/PHP/McvStatus?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/PHP/McvStatus)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/PHP/McvStatus?template=oopsmore&param1=1.1&param2=1.1)
:::
:::
...
::: {.twikiTopic}
Mcv Status {#mcv-status .twikiTopicTitle}
==========
...
[MCV000](PhpSatMCV000){.twikiLink}-pattern:

-   Operator Expressions
-   Control-flow statements

This means that the security check is capable of analyzing a single
procedural script without function calls.

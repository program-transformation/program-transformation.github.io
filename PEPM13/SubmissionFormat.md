...
-   [Edit
    Page](http://www.program-transformation.org/edit/PEPM13/SubmissionFormat?t=1536828982)
-   [Rename
    Page](http://www.program-transformation.org/rename/PEPM13/SubmissionFormat)
-   [Attach
    File](http://www.program-transformation.org/attach/PEPM13/SubmissionFormat)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/PEPM13/SubmissionFormat?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/PEPM13/SubmissionFormat?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    2](http://www.program-transformation.org/view/PEPM13/SubmissionFormat?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/PEPM13/SubmissionFormat?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/PEPM13/SubmissionFormat?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/PEPM13/SubmissionFormat)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/PEPM13/SubmissionFormat?template=oopsmore&param1=1.2&param2=1.2)
:::
:::
...
Back to the
[CallForTutorials[^?^](http://www.program-transformation.org/edit/PEPM13/CallForTutorials?topicparent=PEPM13.SubmissionFormat)]{.twikiNewLink

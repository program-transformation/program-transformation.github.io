...
-   [Edit
    Page](http://www.program-transformation.org/edit/BX12/SubmissionFormat?t=1536828749)
-   [Rename
    Page](http://www.program-transformation.org/rename/BX12/SubmissionFormat)
-   [Attach
    File](http://www.program-transformation.org/attach/BX12/SubmissionFormat)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/BX12/SubmissionFormat?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/BX12/SubmissionFormat?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    2](http://www.program-transformation.org/view/BX12/SubmissionFormat?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/BX12/SubmissionFormat?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/BX12/SubmissionFormat?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/BX12/SubmissionFormat)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/BX12/SubmissionFormat?template=oopsmore&param1=1.2&param2=1.2)
:::
:::
...
Back to the
[CallForTutorials[^?^](http://www.program-transformation.org/edit/BX12/CallForTutorials?topicparent=BX12.SubmissionFormat)]{.twikiNewLink

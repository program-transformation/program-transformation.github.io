...
-   [Edit
    Page](http://www.program-transformation.org/edit/BX12/ToolPaperAdvice?t=1536828743)
-   [Rename
    Page](http://www.program-transformation.org/rename/BX12/ToolPaperAdvice)
-   [Attach
    File](http://www.program-transformation.org/attach/BX12/ToolPaperAdvice)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/BX12/ToolPaperAdvice?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/BX12/ToolPaperAdvice?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    5](http://www.program-transformation.org/view/BX12/ToolPaperAdvice?rev=1.5)
    [(diff 4)](http://www.program-transformation.org/rdiff/BX12/ToolPaperAdvice?rev1=1.5&rev2=1.4)
-   [Rev
    4](http://www.program-transformation.org/view/BX12/ToolPaperAdvice?rev=1.4)
    [(diff 3)](http://www.program-transformation.org/rdiff/BX12/ToolPaperAdvice?rev1=1.4&rev2=1.3)
-   [Rev
    3](http://www.program-transformation.org/view/BX12/ToolPaperAdvice?rev=1.3)
    [(diff 2)](http://www.program-transformation.org/rdiff/BX12/ToolPaperAdvice?rev1=1.3&rev2=1.2)
-   [Total
    History](http://www.program-transformation.org/rdiff/BX12/ToolPaperAdvice)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/BX12/ToolPaperAdvice?template=oopsmore&param1=1.5&param2=1.5)
:::
:::

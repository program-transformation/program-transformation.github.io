...
-   [Edit
    Page](http://www.program-transformation.org/edit/BX12/WebTools?t=1536828752)
-   [Rename
    Page](http://www.program-transformation.org/rename/BX12/WebTools)
-   [Attach
    File](http://www.program-transformation.org/attach/BX12/WebTools)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/BX12/WebTools?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/BX12/WebTools?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    1](http://www.program-transformation.org/view/BX12/WebTools?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/BX12/WebTools)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/BX12/WebTools?template=oopsmore&param1=1.1&param2=1.1)
:::
:::
...
-   [RoadMap[^?^](http://www.program-transformation.org/edit/BX12/RoadMap?topicparent=BX12.WebTools)]{.twikiNewLink
    style="background : #FFFFCE;"}
-   [WebIndex](WebIndex){.twikiLink}: all topics in the BX12 web
...
-   [WebContents[^?^](http://www.program-transformation.org/edit/BX12/WebContents?topicparent=BX12.WebTools)]{.twikiNewLink

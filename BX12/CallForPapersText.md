...
-   [Edit
    Page](http://www.program-transformation.org/edit/BX12/CallForPapersText?t=1536828745)
-   [Rename
    Page](http://www.program-transformation.org/rename/BX12/CallForPapersText)
-   [Attach
    File](http://www.program-transformation.org/attach/BX12/CallForPapersText)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/BX12/CallForPapersText?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/BX12/CallForPapersText?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    6](http://www.program-transformation.org/view/BX12/CallForPapersText?rev=1.6)
    [(diff 5)](http://www.program-transformation.org/rdiff/BX12/CallForPapersText?rev1=1.6&rev2=1.5)
-   [Rev
    5](http://www.program-transformation.org/view/BX12/CallForPapersText?rev=1.5)
    [(diff 4)](http://www.program-transformation.org/rdiff/BX12/CallForPapersText?rev1=1.5&rev2=1.4)
-   [Rev
    4](http://www.program-transformation.org/view/BX12/CallForPapersText?rev=1.4)
    [(diff 3)](http://www.program-transformation.org/rdiff/BX12/CallForPapersText?rev1=1.4&rev2=1.3)
-   [Total
    History](http://www.program-transformation.org/rdiff/BX12/CallForPapersText)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/BX12/CallForPapersText?template=oopsmore&param1=1.6&param2=1.6)
:::
:::

...
-   [Edit
    Page](http://www.program-transformation.org/edit/PEPM11/PublicityList06?t=1536828950)
-   [Rename
    Page](http://www.program-transformation.org/rename/PEPM11/PublicityList06)
-   [Attach
    File](http://www.program-transformation.org/attach/PEPM11/PublicityList06)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/PEPM11/PublicityList06?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/PEPM11/PublicityList06?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    5](http://www.program-transformation.org/view/PEPM11/PublicityList06?rev=1.5)
    [(diff 4)](http://www.program-transformation.org/rdiff/PEPM11/PublicityList06?rev1=1.5&rev2=1.4)
-   [Rev
    4](http://www.program-transformation.org/view/PEPM11/PublicityList06?rev=1.4)
    [(diff 3)](http://www.program-transformation.org/rdiff/PEPM11/PublicityList06?rev1=1.4&rev2=1.3)
-   [Rev
    3](http://www.program-transformation.org/view/PEPM11/PublicityList06?rev=1.3)
    [(diff 2)](http://www.program-transformation.org/rdiff/PEPM11/PublicityList06?rev1=1.3&rev2=1.2)
-   [Total
    History](http://www.program-transformation.org/rdiff/PEPM11/PublicityList06)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/PEPM11/PublicityList06?template=oopsmore&param1=1.5&param2=1.5)
:::
:::
...
[Address](http://www.program-transformation.org/PEPM11/PublicityList06?sortcol=0&table=1&up=0#sorted_table "Sort by this column")
:::
:::
:::
:::
...
[List
name](http://www.program-transformation.org/PEPM11/PublicityList06?sortcol=1&table=1&up=0#sorted_table "Sort by this column")

[Sent](http://www.program-transformation.org/PEPM11/PublicityList06?sortcol=2&table=1&up=0#sorted_table "Sort by this column")

[OK](http://www.program-transformation.org/PEPM11/PublicityList06?sortcol=3&table=1&up=0#sorted_table "Sort by this column")

[Comment](http://www.program-transformation.org/PEPM11/PublicityList06?sortcol=4&table=1&up=0#sorted_table "Sort by this column")

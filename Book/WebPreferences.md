...
-   [Edit
    Page](http://www.program-transformation.org/edit/Book/WebPreferences?t=1536829086)
-   [Rename
    Page](http://www.program-transformation.org/rename/Book/WebPreferences)
-   [Attach
    File](http://www.program-transformation.org/attach/Book/WebPreferences)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/Book/WebPreferences?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/Book/WebPreferences?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    3](http://www.program-transformation.org/view/Book/WebPreferences?rev=1.3)
    [(diff 2)](http://www.program-transformation.org/rdiff/Book/WebPreferences?rev1=1.3&rev2=1.2)
-   [Rev
    2](http://www.program-transformation.org/view/Book/WebPreferences?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/Book/WebPreferences?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/Book/WebPreferences?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/Book/WebPreferences)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/Book/WebPreferences?template=oopsmore&param1=1.3&param2=1.3)
:::
:::
...
[]{#TWiki_Book_Web_Preferences} TWiki.Book Web Preferences
----------------------------------------------------------

The following settings are ***web preferences*** of the TWiki.Book web.
...
-   -   Set BOOKURL = <http://www.cs.uu.nl/~visser/book>

<!-- -->

-   -   Set WEBTITLE = Strategies for Program Transformation

<!-- -->

-   -   Set WEBLOGO =
        /pub/Stratego/StrategoLogo/StrategoLogoTextless-100px.png
    -   Set WEBICON = /pub/StrategoLogoIcon.png

<!-- -->

-   List of topics of the TWiki.Book web:
...
-   Default template for new topics and form(s) for this web:
    -   [WebTopicEditTemplate[^?^](http://www.program-transformation.org/edit/Book/WebTopicEditTemplate?topicparent=Book.WebPreferences)]{.twikiNewLink
...
-   Users or groups who ***are not*** / ***are*** allowed to ***view***
    / ***change*** / ***rename*** topics in the Book web: (See

...
-   [Edit
    Page](http://www.program-transformation.org/edit/IPA06/WebIndex?t=1536827641)
-   [Rename
    Page](http://www.program-transformation.org/rename/IPA06/WebIndex)
-   [Attach
    File](http://www.program-transformation.org/attach/IPA06/WebIndex)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/IPA06/WebIndex?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/IPA06/WebIndex?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    2](http://www.program-transformation.org/view/IPA06/WebIndex?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/IPA06/WebIndex?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/IPA06/WebIndex?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/IPA06/WebIndex)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/IPA06/WebIndex?template=oopsmore&param1=1.2&param2=1.2)
:::
:::
...
-   [CourseExercises](CourseExercises){.twikiLink}
-   [CourseMaterial](CourseMaterial){.twikiLink}
-   [CourseSoftware](CourseSoftware){.twikiLink}
-   [GettingStarted](GettingStarted){.twikiLink}

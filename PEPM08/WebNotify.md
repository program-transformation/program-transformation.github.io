...
-   [Edit
    Page](http://www.program-transformation.org/edit/PEPM08/WebNotify?t=1536827655)
-   [Rename
    Page](http://www.program-transformation.org/rename/PEPM08/WebNotify)
-   [Attach
    File](http://www.program-transformation.org/attach/PEPM08/WebNotify)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/PEPM08/WebNotify?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/PEPM08/WebNotify?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    1](http://www.program-transformation.org/view/PEPM08/WebNotify?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/PEPM08/WebNotify)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/PEPM08/WebNotify?template=oopsmore&param1=1.1&param2=1.1)
:::
:::
...
email when topics change in the **TWiki.PEPM08** web. This is a
...
-   [MyName[^?^](http://www.program-transformation.org/edit/Main/MyName?topicparent=PEPM08.WebNotify)]{.twikiNewLink

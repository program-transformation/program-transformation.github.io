...
-   [Edit
    Page](http://www.program-transformation.org/edit/PEPM08/SubmissionFormat?t=1536828931)
-   [Rename
    Page](http://www.program-transformation.org/rename/PEPM08/SubmissionFormat)
-   [Attach
    File](http://www.program-transformation.org/attach/PEPM08/SubmissionFormat)

<!-- -->

-   [Printable](http://www.program-transformation.org/view/PEPM08/SubmissionFormat?skin=print.pattern)
-   [Wiki
    Source](http://www.program-transformation.org/view/PEPM08/SubmissionFormat?skin=text&raw=on&contenttype=text/plain)

<!-- -->

-   [Rev
    2](http://www.program-transformation.org/view/PEPM08/SubmissionFormat?rev=1.2)
    [(diff 1)](http://www.program-transformation.org/rdiff/PEPM08/SubmissionFormat?rev1=1.2&rev2=1.1)
-   [Rev
    1](http://www.program-transformation.org/view/PEPM08/SubmissionFormat?rev=1.1)
-   [Total
    History](http://www.program-transformation.org/rdiff/PEPM08/SubmissionFormat)

<!-- -->

-   [More
    \...](http://www.program-transformation.org/oops/PEPM08/SubmissionFormat?template=oopsmore&param1=1.2&param2=1.2)
:::
:::
...
Back to the
[CallForTutorials[^?^](http://www.program-transformation.org/edit/PEPM08/CallForTutorials?topicparent=PEPM08.SubmissionFormat)]{.twikiNewLink
